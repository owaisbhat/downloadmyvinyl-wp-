...
command = ' '.join([
    lessc,
    '"' + os.path.abspath(os.path.join(cwd, "../tdr-framework-core/less/thunder.less")) + '"',
    '"' + style_css + '"' 
])
...
try:
  if sys.argv[1] == '-m':
    ...
    theme_header_path = os.path.abspath(os.path.join(cwd, "../tdr-framework-core/less/theme.less"))
