<?php get_header(); ?>
	...
	<div id="content" class="full-width portfolio-<?php echo $portfolio_width; ?>">
		...
		<div class="single-navigation clearfix">
			<?php $previous_post_link = previous_post_link_plus(array('format' => '%link', 'link' => __('Previous', 'Avada'), 'in_same_tax' => 'portfolio_category', 'in_cats' => $nav_categories, 'return' => 'href')); ?>
			<?php if($previous_post_link):
			if($portfolioID) {
				$previous_post_link = tf_addUrlParameter($previous_post_link, 'portfolioID', $portfolioID);
			}
			?>
			<a href="<?php echo $previous_post_link; ?>" rel="prev">Previous</a>
			<?php endif; ?>
			<?php $next_post_link = next_post_link_plus(array('format' => '%link', 'link' => __('Next', 'Avada'), 'in_same_tax' => 'portfolio_category', 'in_cats' => $nav_categories, 'return' => 'href')); ?>
			<?php if($next_post_link):
			if($portfolioID) {
				$next_post_link = tf_addUrlParameter($next_post_link, 'portfolioID', $portfolioID);
			}
			?>
			<a href="<?php echo $next_post_link; ?>" rel="next">Next</a>
			<?php endif; ?>
		</div>
