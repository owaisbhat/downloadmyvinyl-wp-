...
function shortcode_recent_posts($atts, $content = null) {
	...
	if($atts['excerpt'] == "yes"):
	if($atts['strip_html'] == "true") {
		$stripped_content = strip_shortcodes( strip_tags( tf_content( $atts['excerpt_words'] ) ) );
	} else {
		$stripped_content = strip_shortcodes( tf_content( $atts['excerpt_words'] ) );
	}
