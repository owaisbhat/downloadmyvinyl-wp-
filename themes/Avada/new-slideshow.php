						...
						<div class="image">
								...
								<div class="image-extras">
									<div class="image-extras-content">
										...
										?>
										<a class="icon gallery-icon" href="<?php echo $full_image[0]; ?>" rel="prettyPhoto[gallery<?php echo $post->ID; ?>]">Gallery</a>
										<h3><?php the_title(); ?></h3>
									</div>
								</div>
						</div>
						...
						<div class="image">
								...
								<div class="image-extras">
									<div class="image-extras-content">
										...
										?>
										<a class="icon gallery-icon" href="<?php echo $full_image[0]; ?>" rel="prettyPhoto[gallery<?php echo $post->ID; ?>]">Gallery</a>										<h3><?php the_title(); ?></h3>
									</div>
								</div>
						</div>
					</li>
